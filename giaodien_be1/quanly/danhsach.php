...
// Câu truy vấn SQL
$sql = "SELECT * FROM products LIMIT $begin, 3";
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="fullproducts.php">Tất cả sản phẩm</a></li>
                            <li>
                                <hr class="dropdown-divider" />
                            </li>
                            <li><a class="dropdown-item" href="#!">Ô tô</a></li>
                            <li><a class="dropdown-item" href="#!">Mô tô</a></li>
                        </ul>
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="crud.php">Admin</a></li>
                    </li>
                </ul>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center">
                                    <!-- Thêm id của sản phẩm vào URL để truyền đến item.php -->
                                    <a class="btn btn-outline-dark mt-auto" href="item.php?page_layout=<?php echo $row['id']?>">Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
